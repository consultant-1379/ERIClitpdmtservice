...
/**
 * This exception is thrown when an invalid child node is requested to be added
 * to a parent node
 */
@CausesStatusCode(UNPROCESSABLE)
@CustomErrorType("InvalidChildTypeError")
public class InvalidChildTypeException extends BusinessException {
	 ...
	 * @param message
	 */
	public InvalidChildTypeException(String message) {
		super(message);
	}
}
